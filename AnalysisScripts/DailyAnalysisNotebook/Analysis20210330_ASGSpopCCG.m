...
for sm1 = 1:6
    for sm2 = 1:6
        temp(:,sm1,sm2) = popCCG.WAKEstate.cellsmean.(CellClass.celltypes{sm1})(:,sm2);
    end
end
...
plot(popCCG.WAKEstate.t_ccg,popCCG.WAKEstate.pop.Mode6(:,6),'linewidth',1,'color',GScolor)
hold on
box off
plot(popCCG.WAKEstate.t_ccg,popCCG.WAKEstate.pop.Mode6(:,7),'linewidth',1,'color',GScolor.*0.7)
...
subplot(3,3,2)
plot(popCCG.WAKEstate.t_ccg,popCCG.WAKEstate.pop.Mode7(:,6),'linewidth',1,'color',GScolor.*0.7)
hold on
box off
plot(popCCG.WAKEstate.t_ccg,popCCG.WAKEstate.pop.Mode7(:,7),'k','linewidth',1)
legend('GS','AS')
ylabel('AS Rate')
plot([0 0],[0 1],'--','color',GScolor.*0.7)
xlabel('t - rel to ref spike (s)')
...
subplot(3,3,4)
plot(popCCG.WAKEstate.t_ccg,GSGS,'linewidth',1,'color',GScolor)
%plot(popCCG.WAKEstate.t_ccg,popCCG.WAKEstate.pop.Mode6(:,6))
hold on
box off
%plot(popCCG.WAKEstate.t_ccg,popCCG.WAKEstate.pop.Mode6(:,7))
plot(popCCG.WAKEstate.t_ccg,GSAS,'linewidth',1,'color',GScolor.*0.7)
legend('GS','AS')
ylabel('GS Rate')
plot([0 0],[0 1],'--','color',GScolor.*0.7)
xlabel('t - rel to ref spike (s)')
...
subplot(3,3,5)
plot(popCCG.WAKEstate.t_ccg,ASGS,'linewidth',1,'color',GScolor.*0.7)
hold on
box off
plot(popCCG.WAKEstate.t_ccg,ASAS_same,'linewidth',1,'color','k')
plot(popCCG.WAKEstate.t_ccg,ASAS_diff,'linewidth',1,'color',[0.5 0.5 0.5])
legend('GS','Same','Diff')
ylabel('AS Rate')
...
hold on
box off
plot(popCCG.WAKEstate.t_ccg,popCCG.WAKEstate.pop.Mode7(:,6),'k','linewidth',1)
plot([0 0],[0 1],'--','color',GScolor)
xlabel('t - rel to GS spike (s)')
ylabel('Pop Rate (spk/s)')

subplot(3,3,8)
plot(popCCG.WAKEstate.t_ccg,popCCG.WAKEstate.pop.Mode6(:,7),'linewidth',1,'color',GScolor)
hold on
box off
plot(popCCG.WAKEstate.t_ccg,popCCG.WAKEstate.pop.Mode7(:,7),'k','linewidth',1)
...
subplot(3,3,1)
%plot(popCCG.WAKEstate.t_ccg,GSGS)
plot(popCCG.WAKEstate.t_ccg,popCCG.WAKEstate.pop.Mode6(:,6),'linewidth',0.5,'color',GScolor)
hold on
box off
plot(popCCG.WAKEstate.t_ccg,popCCG.WAKEstate.pop.Mode6(:,7),'linewidth',0.5,'color',GScolor.*0.7)
%xlabel('Time relative to GS spike')
%plot(popCCG.WAKEstate.t_ccg,GSAS)
%legend('GS','AS')
ylabel('GS Rate')
...
subplot(3,3,2)
plot(popCCG.WAKEstate.t_ccg,popCCG.WAKEstate.pop.Mode7(:,6),'linewidth',0.5,'color',GScolor.*0.7)
hold on
box off
plot(popCCG.WAKEstate.t_ccg,popCCG.WAKEstate.pop.Mode7(:,7),'k','linewidth',0.5)
%legend('GS','AS')
ylabel('AS Rate')
axis tight
plot([0 0],ylim,'--','color',GScolor.*0.7)
...
subplot(3,3,4)
plot(popCCG.WAKEstate.t_ccg,GSGS,'linewidth',0.5,'color',GScolor)
%plot(popCCG.WAKEstate.t_ccg,popCCG.WAKEstate.pop.Mode6(:,6))
hold on
box off
%plot(popCCG.WAKEstate.t_ccg,popCCG.WAKEstate.pop.Mode6(:,7))
plot(popCCG.WAKEstate.t_ccg,GSAS,'linewidth',0.5,'color',GScolor.*0.7)
%legend('GS','AS')
ylabel('GS Rate')
axis tight
plot([0 0],ylim,'--','color',GScolor.*0.7)
...
subplot(3,3,5)
plot(popCCG.WAKEstate.t_ccg,ASGS,'linewidth',0.5,'color',GScolor.*0.7)
hold on
box off
plot(popCCG.WAKEstate.t_ccg,ASAS_same,'linewidth',0.5,'color','k')
plot(popCCG.WAKEstate.t_ccg,ASAS_diff,'linewidth',0.5,'color',[0.5 0.5 0.5])
% legend('GS','Same','Diff')
ylabel('AS Rate')
axis tight
plot([0 0],ylim,'--','color',GScolor.*0.7)
...
hold on
box off
plot(popCCG.WAKEstate.t_ccg,popCCG.WAKEstate.pop.Mode7(:,6),'k','linewidth',0.5)
axis tight
...
subplot(3,3,8)
plot(popCCG.WAKEstate.t_ccg,popCCG.WAKEstate.pop.Mode6(:,7),'linewidth',0.5,'color',GScolor)
hold on
box off
plot(popCCG.WAKEstate.t_ccg,popCCG.WAKEstate.pop.Mode7(:,7),'k','linewidth',0.5)
axis tight
...
for sm1 = 1:6
    for sm2 = 1:6
        subplot(6,6,sm2+(sm1-1).*6)
            ylim([min(popCCG.WAKEstate.cellsmean.(CellClass.celltypes{morder(sm1)})(:)) max(popCCG.WAKEstate.cellsmean.(CellClass.celltypes{morder(sm1)})(:))])
            plot([0 0],ylim,'--','color',modecolors{morder(sm2)},'linewidth',1)
            hold on
            plot(popCCG.WAKEstate.t_ccg,popCCG.WAKEstate.cellsmean.(CellClass.celltypes{morder(sm1)})(:,morder(sm2)),'linewidth',0.5,'color',modecolors{morder(sm1)})
            hold on
            box on
...
%%
GScouplingallcells = popCCG.WAKEstate.cells.Mode6(:,CellClass.Mode6);
tempmerge = cat(1,ModeHMM.WAKEstate(:).logrates);
GSrate = tempmerge(:,6);
tempmerge = cat(1,ModeHMM.WAKEstate(:).cvs);
GScv = tempmerge(:,6);
